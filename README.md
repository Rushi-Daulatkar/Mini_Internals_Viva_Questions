...
| **JavaScript** | Vanilla JS | Handles the core functionality: data rendering, section toggling (accordion logic), and real-time search/filtering. |
...
* **Expand/Collapse:** Click on any section header (e.g., **I. Foundational Concepts**) to view or hide its questions.
